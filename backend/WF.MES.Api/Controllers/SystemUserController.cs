...
public class SystemUserController(IUserService userService) : WfApiControllerBase
{
    ...
    public async Task<ApiResult<UserDto>> GetById(long id)
    {
        ...
        return user is null ? ApiResult<UserDto>.FailByCode(WfMessageCodes.CommonNotFound, 404) : ApiResult<UserDto>.Ok(user);
    }
