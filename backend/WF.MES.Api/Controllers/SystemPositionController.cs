...
public class SystemPositionController(IPositionService positionService) : WfApiControllerBase
{
    ...
    public async Task<ApiResult<PositionDto>> GetById(long id)
    {
        ...
        return position is null ? ApiResult<PositionDto>.FailByCode(WfMessageCodes.CommonNotFound, 404) : ApiResult<PositionDto>.Ok(position);
    }
