...
public class SysRoleController(IRoleService roleService) : WfApiControllerBase
{
    ...
    public async Task<ApiResult<RoleDto>> GetById(long id)
    {
        ...
        return role is null ? ApiResult<RoleDto>.Fail("角色不存在", 404) : ApiResult<RoleDto>.Ok(role);
    }
