...
public class SystemDeptController(IDeptService deptService) : WfApiControllerBase
{
    ...
    public async Task<ApiResult<DeptDto>> GetById(long id)
    {
        ...
        return dept is null ? ApiResult<DeptDto>.FailByCode(WfMessageCodes.CommonNotFound, 404) : ApiResult<DeptDto>.Ok(dept);
    }
