...
public partial class BarcodeQaReviewUploadDialogWindow : HandyControl.Controls.Window
{
    private readonly BarcodeQaReviewUploadDialogViewModel _viewModel;
    private bool _dialogResult;

    private BarcodeQaReviewUploadDialogWindow(IBarcodeQaReviewService qaService, int ruleId)
    {
        InitializeComponent();
    ...
    {
        var window = new BarcodeQaReviewUploadDialogWindow(qaService, ruleId)
        {
